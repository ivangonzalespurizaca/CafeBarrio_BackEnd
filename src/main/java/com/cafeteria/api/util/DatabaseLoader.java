...
public class DatabaseLoader implements CommandLineRunner {
    ...
    // Repositorios necesarios para guardar los datos iniciales
    private final CategoriaRepository categoriaRepository;
    private final ProductoRepository productoRepository;
    private final RolRepository rolRepository;
    private final UsuarioRepository usuarioRepository;

    // Herramienta para encriptar la contraseña del administrador
    private final BCryptPasswordEncoder passwordEncoder = new BCryptPasswordEncoder();

    @Override
    public void run(String... args) throws Exception {

        // Solo inserta datos si la tabla de categorías está vacía
        if (categoriaRepository.count() == 0) {

            // 1. Crear y guardar las categorías base
            ...
            // 2. Poblar la categoría CAFÉ con imágenes de Cloudinary
            ...
            // 4. Poblar la categoría ACCESORIOS
